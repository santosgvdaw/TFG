        ...
        <div class="container">
            <div class="row">
                <?php if ($this->isLogged) { ?>
                    <a href='crearUbicacion.php' class='col-1 btn btn-success'>
                    ...
                    <tbody>
                        <?php foreach ($this->ubicaciones as $ubicacion) { ?>
                            <tr class="text-center">
                                ...
                                <?php if ($this->isLogged && $this->rol == 'admin') { ?>
                                    <td>
                                        <a href='actualizarUbicacion.php?id=<?= $ubicacion->getId() ?>' class='btn btn-warning'>
                                    ...
                                    <td>
                                        <a href='borrarUbicacion.php?id=<?= $ubicacion->getId() ?>' class='btn btn-danger'>
