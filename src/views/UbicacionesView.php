...
class UbicacionesView extends BaseView
{
    private $ubicaciones;
        ...
        <div class="container">
            <div class="row">
                <?php if ($this->isLogged) { ?>
                    <div class="col mb-3">
                        <a href='crearUbicacion.php' class='btn btn-success'>
                    ...
                    <tbody>
                        <?php foreach ($this->ubicaciones as $ubicacion) { ?>
                            <tr class="text-center">
                                ...
                                <?php if ($this->isLogged && $this->rol == 'admin') { ?>
                                    <td>
                                        <a href='actualizarUbicacion.php?id=<?= $ubicacion->getId() ?>&con=<?= $ubicacion->getConcurrencia() ?>' class='btn btn-warning'>
                                    ...
                                    <td>
                                        <a href='borrarUbicacion.php?id=<?= $ubicacion->getId() ?>&con=<?= $ubicacion->getConcurrencia() ?>' class='btn btn-danger'>
