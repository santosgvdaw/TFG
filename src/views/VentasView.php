        ...
        <div class="container">
            <div class="row">
                <?php if ($this->isLogged) { ?>
                    <a href='crearVenta.php' class='col-1 btn btn-success'>
                    ...
                    <tbody>
                        <?php foreach ($this->ventas as $venta) { ?>
                            <tr class="text-center">
                                ...
                                <?php if ($this->isLogged) { ?>
                                    <td>
                                        <a href='actualizarVenta.php?id=<?= $venta->getId() ?>' class='btn btn-warning'>
                                    ...
                                    <td>
                                        <a href='borrarVenta.php?id=<?= $venta->getId() ?>' class='btn btn-danger'>
